...
from ctzzy.utils.encoding import decode_from_b64, encode_to_b64
from ctzzy.utils.encoding import digest_from_b64
from ctzzy.utils.logger import logger
...
def read_log_list(filename):
    ...
    '''
    filename = abspath(expanduser(filename)) # exanduser 展开~路径
